...
namespace Pawnmorph
{
	...
	public static class AnimalClassUtilities
	{
		...
		[NotNull]
		private static readonly Dictionary<AnimalClassBase, List<MutationDef>> _mutationClassCache =
			new Dictionary<AnimalClassBase, List<MutationDef>>();

		[NotNull]
		private static readonly Dictionary<AnimalClassBase, float> _accumInfluenceCache =
		...
		[NotNull]
		private static readonly Dictionary<AnimalClassBase, IReadOnlyList<ThingDef>> _associatedAnimalsCached =
