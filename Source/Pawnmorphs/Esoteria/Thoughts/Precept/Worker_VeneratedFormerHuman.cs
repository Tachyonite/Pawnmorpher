...
namespace Pawnmorph.Thoughts.Precept
{
    ...
    {
        private readonly static Dictionary<Ideo, bool> _cache = new Dictionary<Ideo, bool>();

        static bool ContainsOverride([NotNull] Ideo ideo)
        {
        ...
        {
            var st = (p.GetQuantizedSapienceLevel());
